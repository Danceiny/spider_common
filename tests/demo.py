...
from spider_common.recognize.api import Api

api_key = 'api_bx_spider'
signatures = {'1': "wechat:tanceiny"}
api = Api(api_key='api_bxxer', api_secret='mAOpxXiPx1cGjuk@w', biz_channel='aixer')
ret = api.recognize_contacts(signatures)
